#
# 'ConvertFrom-VMHostMCELog' 모듈의 모듈 매니페스트
#
# 생성자: Han Ho-Sung
#
# 생성 날짜: 2017-08-25
...
RootModule = 'ConvertFrom-VMHostMCELog.psm1'
...
Description = 'Decode ESXi MCE(Machine Check Exception) log entry of the vmkernel.log.'
...
FunctionsToExport = @('ConvertFrom-VMHostCPUID', 'ConvertFrom-IA32_MCG_CAP', 'ConvertFrom-VMHostMCELog')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://raw.githubusercontent.com/funksoul/ConvertFrom-VMHostMCELog/master/LICENSE'

        # 이 프로젝트에 대한 기본 웹 사이트의 URL입니다.
        ProjectUri = 'https://github.com/funksoul/ConvertFrom-VMHostMCELog'
